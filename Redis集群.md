...
|      IP       | PORT |  角色  |
| :-----------: | :--: | :----: |
| 182.61.10.220 | 7001 | master |
| 182.61.10.220 | 7002 | slave  |
| 182.61.10.220 | 7003 | slave  |
...
```properties
# redis实例的声明 IP
replica-announce-ip 182.61.10.220
```
...
```sh
# 逐一执行
sed -i '1a replica-announce-ip 182.61.10.220' 7001/redis.conf
sed -i '1a replica-announce-ip 182.61.10.220' 7002/redis.conf
sed -i '1a replica-announce-ip 182.61.10.220' 7003/redis.conf

# 或者一键修改
printf '%s\n' 7001 7002 7003 | xargs -I{} -t sed -i '1a replica-announce-ip 182.61.10.220' {}/redis.conf
```
...
| 节点 |      IP       | PORT  |
| ---- | :-----------: | :---: |
| s1   | 182.61.10.220 | 27001 |
| s2   | 182.61.10.220 | 27002 |
| s3   | 182.61.10.220 | 27003 |
...
```ini
port 27001
sentinel announce-ip 182.61.10.220
sentinel monitor mymaster 182.61.10.220 7001 2
...
- `sentinel monitor mymaster 182.61.10.220 7001 2`：指定主节点信息
  - `mymaster`：主节点名称，自定义，任意写
  - `182.61.10.220 7001`：主节点的ip和端口
  - `2`：选举master时的quorum值
...
| :-----------: | :--: | :----: |
| 182.61.10.220 | 7001 | master |
| 182.61.10.220 | 7002 | master |
| 182.61.10.220 | 7003 | master |
| 182.61.10.220 | 8001 | slave  |
| 182.61.10.220 | 8002 | slave  |
| 182.61.10.220 | 8003 | slave  |
...
# 创建集群
./redis-trib.rb create --replicas 1 182.61.10.220:7001 182.61.10.220:7002 182.61.10.220:7003 182.61.10.220:8001 182.61.10.220:8002 182.61.10.220:8003
```
...
```sh
redis-cli --cluster create --cluster-replicas 1 182.61.10.220:7001 182.61.10.220:7002 182.61.10.220:7003 182.61.10.220:8001 182.61.10.220:8002 182.61.10.220:8003
```
